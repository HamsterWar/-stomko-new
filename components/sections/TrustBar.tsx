...
export function TrustBar() {
  ...
  return (
    <section className="relative border-y border-[#e8f1f7] bg-white">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <motion.div
          ...
          className="grid gap-3 py-6 sm:grid-cols-2 lg:grid-cols-5"
        >
          {trustPoints.map((p) => {
            ...
            return (
              ...
              >
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#eaf4fa] text-brand-primary">
