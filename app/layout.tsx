...
export const metadata: Metadata = {
  ...
  description:
    "Сеть стоматологических клиник в Москве с 1995 года. Имплантация, лечение зубов, протезирование и хирургия у метро Сокол и Беломорская. Бесплатная консультация, скидка 10% постоянным пациентам.",
  keywords: [
    "стоматология Москва",
    "стоматология Сокол",
  ...
  openGraph: {
    ...
    description:
      "Имплантация, лечение зубов, протезирование и хирургия. 30 лет опыта. Бесплатная консультация, скидка 10% постоянным пациентам.",
